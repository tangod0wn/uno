            ...
            return this.each(function() {
                ...
                if(thisSettings.steps > 1) {
                    ...
                    if(thisSettings.showButtons) {
                       ...
                       //     paginationHtml += thisSettings.submitButton?'<button v-on:click="CaclulateSavings" class="submit '+thisSettings.submitButtonClass+'">'+thisSettings.submitButtonText+'</button>':'';
                        paginationHtml  += '</div>';
